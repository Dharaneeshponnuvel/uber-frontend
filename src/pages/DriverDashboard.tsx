  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeRide && (
          <div className="card mb-8 border-l-4 border-l-green-500">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className={`status-badge ${activeRide.status === 'accepted' ? 'status-accepted' : 'status-requested'}`}>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <div className="flex items-center text-sm">
                  ...
                  <span className="text-gray-700">Pickup: {activeRide.pickup_address}</span>
                </div>
                <div className="flex items-center text-sm">
                  <MapPin className="h-4 w-4 mr-2 text-red-500" />
                  <span className="text-gray-700">Drop-off: {activeRide.dropoff_address}</span>
                </div>
                {activeRide.rider && (
                  <div className="flex items-center text-sm">
                    <User className="h-4 w-4 mr-2 text-blue-500" />
                    <span className="text-gray-700">
                      Rider: {activeRide.rider.first_name} {activeRide.rider.last_name}
                    </span>
                  </div>
                )}
              </div>
              ...
              <div className="text-right">
                <p className="text-2xl font-bold text-green-600 mb-2">
                  ${activeRide.estimated_fare.toFixed(2)}
                </p>
                <p className="text-sm text-gray-500 mb-4">
                  {activeRide.distance} miles • {activeRide.ride_type}
                </p>
        ...
        <div className={`card ${activeRide ? 'opacity-50' : ''}`}>
          <div className="flex items-center justify-between mb-6">
            ...
            {activeRide && (
              <p className="text-blue-600 bg-blue-50 px-3 py-1 rounded-full text-sm">
                Complete current ride to see new requests
              </p>
            )}
          </div>
          ...
          {activeRide ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">You have an active ride in progress.</p>
              <p className="text-sm text-gray-500">Complete your current ride to see new requests.</p>
            </div>
          ) : !isOnline ? (
            <div className="text-center py-8">
              <Car className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                    ...
                    <div className="text-right ml-4">
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          disabled={acceptingRide === ride.id || activeRide}
